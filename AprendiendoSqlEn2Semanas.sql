...
insert into Agenda(apellido,nombre,domicilio,telefono)
	values('Gonzalez','Enmanuel',' Urb. Brugal','8098430744');
insert into Agenda(apellido,nombre,domicilio,telefono)
	values('Fernadez','Juan','Urb. Toribio Camilo','888-888-8888');
...
--4- Ingrese los siguientes registros:
 ...
 insert into peliculas (nombre, actor, duracion, cantidad) values ('John wick','Kenue Reeves',110,2);
...
insert into Empleados(nombre,documentos,sexo,domicilio,sueldobasico)
	values('Enmanuel','20170','m','SFM',115000);
insert into Empleados(nombre,documentos,sexo,domicilio,sueldobasico)
...
insert into Empleados(nombre,documento,sexo,domicilio,sueldobasico)
	values('Enmanuel','20165','M','SFM',115000);
insert into empleados (nombre, documento, sexo, domicilio, sueldobasico)
